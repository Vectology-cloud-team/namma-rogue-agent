...
class RogueSourceIdentity:
    ...
    compatibility_patch_identity: str = "patches/0001-ncurses-compatibility.patch"
    source_commit: str = "not-connected-in-phase8"
    build_identity: str = "fake-native-backend"
